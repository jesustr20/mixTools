...
<style type="text/css">@page (esta parte siempre ponemos) { margin-top: 2.5cm; margin-bottom: 2.5cm; margin-right: 3cm; margin-left: 3cm; } body (aqui definimos la letra y el tamaño de todo el documento) { font-family: Candara; font-size: 10pt; } --- de aqui en adelante es lo usual-- div, li, td { text-align: justify; } ul li, ol li{ margin-top: 15px; margin-bottom: 15px; } table, thead, tbody { border-collapse: collapse; box-sizing: border-box; vertical-align: top; } -- esta parte es para firmas en las tablas de firmas que usamos pero ahora no es necesario--- .firmas { border-top: 1px solid #000; } .ajusTabla { font-size: 0.85em; } </style>
-- aqui viene el detalle de la tabla -- -- align siempre sera "centar" -- border siempre sera "0" -- y lo demas igual
<table align="center" border="0" cellpadding="0" cellspacing="0" class="ajusTabla" style="width:100%;"> <colgroup> -- seccion de medicion mediante porcentaje de columnas, depende la cantidad de columnas agregamos el porcenaje como en este ejemplo hay 3 columnas "td" agregamos 3 "col width = .." -- <col width="48%" /> <--- En esta parte definimos el tamaño con porcentaje de una columna <col width="auto" /> <col width="48%" /> </colgroup> <tbody> <tr> <td> </td> <td> </td> <td> </td> </tr> </tbody> </table>
